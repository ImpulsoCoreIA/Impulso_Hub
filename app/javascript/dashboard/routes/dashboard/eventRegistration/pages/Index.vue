  ...
  function humanRecurring(item) {
    ...
    const timezone = item.timezone || LOCAL_TIMEZONE;
    return days ? `${days} às ${time} (${timezone})` : text.fallbackDash;
  }
        ...
        <header class="flex items-start justify-between gap-3">
          <div class="min-w-0 space-y-2">
            ...
            <dl class="space-y-2 text-xs text-n-slate-10">
              ...
              <div class="flex items-center gap-2">
                <dt class="font-medium text-n-slate-9">
                  {{ text.card.labels.expression }}
                </dt>
                <dd class="text-n-slate-12 font-mono">
                  {{ item.scheduleExpression || text.fallbackDash }}
                </dd>
              </div>
              <div class="flex items-center gap-2">
                <dt class="font-medium text-n-slate-9">
